// This code was autogenerated with `dbus-codegen-rust -s -g -c blocking -d org.freedesktop.login1 -p /org/freedesktop/login1 -f org.freedesktop.login1.Manager`, see https://github.com/diwic/dbus-rs
use dbus;
...
#[derive(Debug)]
pub struct OrgFreedesktopLogin1ManagerPrepareForShutdownWithMetadata {
    pub start: bool,
    pub metadata: arg::PropMap,
}

impl arg::AppendAll for OrgFreedesktopLogin1ManagerPrepareForShutdownWithMetadata {
    fn append(&self, i: &mut arg::IterAppend) {
        arg::RefArg::append(&self.start, i);
...
impl arg::ReadAll for OrgFreedesktopLogin1ManagerPrepareForShutdownWithMetadata {
    fn read(i: &mut arg::Iter) -> Result<Self, arg::TypeMismatchError> {
        Ok(OrgFreedesktopLogin1ManagerPrepareForShutdownWithMetadata {
            start: i.read()?,
            metadata: i.read()?,
        })
    }
...
impl dbus::message::SignalArgs for OrgFreedesktopLogin1ManagerPrepareForShutdownWithMetadata {
    const NAME: &'static str = "PrepareForShutdownWithMetadata";
    const INTERFACE: &'static str = "org.freedesktop.login1.Manager";
}
